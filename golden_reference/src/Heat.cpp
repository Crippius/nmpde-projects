...
Heat::output(const unsigned int &time_step) const
{
  ...
  // Questa funzione gestisce l'I/O parallelo in modo corretto.
  // Crea un file .pvtu che fa da "master" e diversi file .vtu (uno per processo)
  // che contengono i dati veri e propri.
...
Heat::solve()
{
  ...
  pcout << "===============================================" << std::endl;
  pcout << "Saving reference solution to disk..." << std::endl;
